 ...
 * @since      1.0.0
 */
class TrueReview_Modern_Block extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			'classname'   => 'truereview_modern_block',
			'description' => esc_html__( 'Display modern style posts list.', 'truereview' )
		);

		// Create the widget.
		parent::__construct(
			'truereview_modern_block',                  // $this->id_base
			esc_html__( 'Modern Block', 'truereview' ), // $this->name
			$widget_options                            // $this->widget_options
		);

		$this->alt_option_name = 'truereview_modern_block';
	}
	...
	public function widget( $args, $instance ) {
		...
		echo $args['before_widget'];
			...
			if ( $cat ) :
				...
				$query = apply_filters( 'truereview_modern_block_arg', $query );
