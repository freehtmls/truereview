...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Text Fonts', 'truereview' ) ) ) );
	$text_fonts     = customizer_library_get_text_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'truereview' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => esc_html__( 'All', 'truereview' ),
		'cyrillic'     => esc_html__( 'Cyrillic', 'truereview' ),
		'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'truereview' ),
		'devanagari'   => esc_html__( 'Devanagari', 'truereview' ),
		'greek'        => esc_html__( 'Greek', 'truereview' ),
		'greek-ext'    => esc_html__( 'Greek Extended', 'truereview' ),
		'khmer'        => esc_html__( 'Khmer', 'truereview' ),
		'latin'        => esc_html__( 'Latin', 'truereview' ),
		'latin-ext'    => esc_html__( 'Latin Extended', 'truereview' ),
		'vietnamese'   => esc_html__( 'Vietnamese', 'truereview' ),
	);
}
endif;
...
function customizer_library_get_text_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'truereview' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'truereview' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'truereview' ),
